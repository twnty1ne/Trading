...
using Trading.Researching.Core.DecisionMaking.Metrics;
...
namespace Trading.Researching.Core.DecisionMaking.Agorithms
{
        ...
        where TParameter : Enum
    {
        ...
        {
            var data = _criterias.Select(x => _criterias.Select(y => Convert.ToDouble(x.Importance) / Convert.ToDouble(y.Importance)));
